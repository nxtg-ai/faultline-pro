...
> **Last Updated**: 2026-03-21 (N-127 v0.4.0 publish prep — CHANGELOG [v0.4.0] block cut (N-119–N-127); @nxtg/faultline + @nxtg/faultline-api bumped 0.2.0→0.4.0; README GDPR + mutation testing rows added; 15 release-prep tests (RP16–RP30). README badge 4,301. 4,301 tests. 127 initiatives SHIPPED.)
