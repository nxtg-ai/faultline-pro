...
[![Tests](https://img.shields.io/badge/tests-4377%20passing-brightgreen)](tests/)
...
| Mutation-tested core | Stryker gate: claim forensics 75.31%, webhook store 91.45%, GDPR stores (costs 96.81%, notifications 95.76%, schedules 77.35%); CRUCIBLE Protocol Gate 6 |
